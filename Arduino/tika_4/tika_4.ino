#define RPWM1 5  // sağ tekerin pwm'si
#define LPWM1 6  // geri yönlü git
#define R_EN1 7  //enable, hep 1 tut
#define L_EN1 4  //enable, hep 1 tut
#define R_IS1 2  //hep 0
#define L_IS1 3  //hep 0
...
void loop() {
  ...
  if (input[0] > 1450 && input[0] < 1550){
    ...
    analogWrite(RPWM1, spd1); //sağ teker ileri
    digitalWrite(LPWM1, LOW); //sağ teker ileri
    //analogWrite(RPWM2, spd1);
    //digitalWrite(LPWM2, LOW);
  }
  else if (input[0] < 1450){
    analogWrite(LPWM1, spd1);
    digitalWrite(RPWM1, LOW);
    //analogWrite(LPWM2, spd1);
